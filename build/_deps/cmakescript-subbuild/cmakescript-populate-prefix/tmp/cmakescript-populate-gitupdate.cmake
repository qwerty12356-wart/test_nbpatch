...
execute_process(
  COMMAND "/usr/bin/git" show-ref "45f72fdc2d715030c6cb61e3d5977811ea45abda"
  WORKING_DIRECTORY "/home/hein/newproj/build/_deps/cmakescript-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "45f72fdc2d715030c6cb61e3d5977811ea45abda")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("45f72fdc2d715030c6cb61e3d5977811ea45abda" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/45f72fdc2d715030c6cb61e3d5977811ea45abda")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/hein/newproj/build/_deps/cmakescript-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/hein/newproj/build/_deps/cmakescript-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
